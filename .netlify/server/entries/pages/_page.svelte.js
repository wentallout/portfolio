import { c as create_ssr_component, h as escape, v as validate_component, l as createEventDispatcher, d as add_attribute, o as compute_rest_props, p as onDestroy, e as spread, q as escape_attribute_value, f as escape_object } from "../../chunks/index3.js";
...
const HomeSectionTitle = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<h2 class="${"home-section xl-text " + escape(extraClass, true) + " svelte-10xxtlu"}">${escape(title2)}</h2>`;
});
...
const Featured = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<section><div class="${"featured svelte-1619pk2"}"><a href="${"/project"}">${validate_component(HomeSectionTitle, "HomeSectionTitle").$$render(
    $$result,
    {
...
const SaosContainer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Saos, "Saos").$$render($$result, { once, animation }, {}, {
    default: () => {
...
const MyClients = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(SaosContainer, "SaosContainer").$$render($$result, {}, {}, {
    default: () => {
      return `<section><div class="${"clients svelte-1fcocjw"}">${validate_component(HomeSectionTitle, "HomeSectionTitle").$$render($$result, { title: "Worked at" }, {}, {})}
			<div class="${"clients__logo svelte-1fcocjw"}">${validate_component(ExLink, "ExLink").$$render($$result, { href: "https://www.fpt-software.com" }, {}, {
        default: () => {
          return `<img class="${"logo svelte-1fcocjw"}" loading="${"lazy"}" decoding="${"async"}"${add_attribute("src", fpt, 0)} alt="${"FPT Software"}">`;
        }
      })}

				${validate_component(ExLink, "ExLink").$$render($$result, { href: "https://nashtechglobal.com" }, {}, {
        default: () => {
          return `<img class="${"logo svelte-1fcocjw"}" loading="${"lazy"}" decoding="${"async"}"${add_attribute("src", nashtech, 0)} alt="${"NashTech"}">`;
        }
      })}</div></div></section>`;
    }
  })}`;
...
const SVG = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<img${add_attribute("src", src, 0)}${add_attribute("width", width, 0)}${add_attribute("height", height, 0)}${add_attribute("style", style, 0)} loading="${"lazy"}" decoding="${"async"}" alt="${"SVG " + escape(alt, true)}">`;
});
...
const MyTools = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(SaosContainer, "SaosContainer").$$render($$result, {}, {}, {
    default: () => {
      return `<section><div class="${"tool svelte-z96dtp"}">${validate_component(HomeSectionTitle, "HomeSectionTitle").$$render($$result, { title: "My tools" }, {}, {})}

			<div class="${"tool__block svelte-z96dtp"}">${validate_component(Atropos, "Atropos").$$render($$result, { rotateTouch: "scroll-y" }, {}, {
        default: () => {
          return `<div class="${"block__section svelte-z96dtp"}"><div class="${"section__svg svelte-z96dtp"}">${validate_component(SVG, "SVG").$$render(
            $$result,
            {
              width: "120",
              height: "120",
            ...
            {}
				...
				${validate_component(Atropos, "Atropos").$$render($$result, { rotateTouch: "scroll-y" }, {}, {
        default: () => {
          return `<div class="${"block__section svelte-z96dtp"}"><div class="${"section__svg svelte-z96dtp"}">${validate_component(SVG, "SVG").$$render(
            $$result,
            {
...
const AboutMe = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(SaosContainer, "SaosContainer").$$render($$result, {}, {}, {
    default: () => {
      return `<section><div class="${"about svelte-ahnk3g"}">${validate_component(HomeSectionTitle, "HomeSectionTitle").$$render($$result, { title: "About me" }, {}, {})}
