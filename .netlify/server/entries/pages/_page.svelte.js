...
const css$1 = {
  code: ".atropos-container.svelte-142k6d{margin-bottom:var(--space-l)}.btn-seemywork.svelte-142k6d{background-color:var(--primary-500);color:var(--neutral-900)}.btn-seemywork.svelte-142k6d:hover{background-color:var(--primary-600)}.hero.svelte-142k6d{background-image:linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)),\r\n			url('/images/fuji.svg');border-radius:var(--border-radius);width:100%;height:600px;background-position:center;background-repeat:no-repeat;background-size:cover;display:flex;justify-content:center;align-items:center}.hero-text.svelte-142k6d{display:flex;flex-direction:column;justify-content:center;align-items:center;color:var(--neutral-100)}",
  map: null
};
const Hero = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$1);
  return `<div class="${"atropos-container svelte-142k6d"}">${validate_component(Atropos, "Atropos").$$render(
    $$result,
    {
      highlight: "false",
      shadow: "false",
    ...
    {
      default: () => {
        return `<div class="${"hero svelte-142k6d"}"><div class="${"hero-text svelte-142k6d"}"><h1 data-atropos-offset="${"-5"}">Hi! I&#39;m Khoa</h1>
				<p data-atropos-offset="${"-3"}">I code and design.</p>
				<a data-atropos-offset="${"10"}" class="${"btn btn-seemywork svelte-142k6d"}" href="${"/project"}">See my work</a></div></div>`;
      }
    }
  )}
</div>`;
