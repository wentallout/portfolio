...
const Atropos_svelte = (0, import_chunks.c)(($$result, $$props, $$bindings, slots) => {
  let $$restProps = (0, import_chunks.b)($$props, [
    "class",
    "scaleClass",
    "rotateClass",
    "innerClass",
  ...
  return `<div${(0, import_chunks.d)(
    [
      {
        class: (0, import_chunks.e)(cls("atropos", className))
      },
...
const css = {
  code: ".btn-seemywork.svelte-1al32sr{background-color:var(--primary);color:var(--black)}.btn-seemywork.svelte-1al32sr:hover{background-color:var(--primary-hover)}.hero.svelte-1al32sr{background-image:linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)),\r\n			url('/images/fuji.svg');width:100%;height:600px;background-position:center;background-repeat:no-repeat;background-size:cover;display:flex;justify-content:center;align-items:center}.hero-text.svelte-1al32sr{display:flex;flex-direction:column;justify-content:center;align-items:center;color:var(--white)}",
  map: null
};
const Hero = (0, import_chunks.c)(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `${(0, import_chunks.v)(Atropos, "Atropos").$$render(
    $$result,
    {
      class: "my-atropos",
      highlight: "false",
    ...
    {
      default: () => {
        return `<div class="${"hero svelte-1al32sr"}"><div class="${"hero-text svelte-1al32sr"}"><h1 data-atropos-offset="${"-5"}">Hi! I&#39;m Khoa</h1>
			<p data-atropos-offset="${"-3"}">I code and design.</p>
			<a data-atropos-offset="${"10"}" class="${"btn btn-seemywork svelte-1al32sr"}" href="${"/project"}">See my work</a></div></div>`;
      }
    }
  )}`;
});
