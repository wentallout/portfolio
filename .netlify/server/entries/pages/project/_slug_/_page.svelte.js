...
<article class="${"info svelte-1zl6ea"}"><div class="${"small-text project-date svelte-1zl6ea"}">Updated: ${validate_component(Time, "Time").$$render($$result, { relative: true, timestamp: data.date }, {}, {})}</div>
