...
const css = {
  code: ".info.svelte-1jhvvf3{display:block}.project-title.svelte-1jhvvf3{text-transform:capitalize}.project-date.svelte-1jhvvf3{color:var(--neutral-800);display:block;font-weight:300}",
  map: null
};
...
<article class="${"info svelte-1jhvvf3"}"><h1 class="${"xl-text project-title svelte-1jhvvf3"}">${escape(data.title)}</h1>
	<p class="${"small-text project-date svelte-1jhvvf3"}">Created on: ${validate_component(Time, "Time").$$render($$result, { relative: true, timestamp: data.date }, {}, {})}</p>
