import { x as get_store_value, p as onDestroy, s as setContext, w as tick, k as getContext, c as create_ssr_component, b as subscribe, v as validate_component, y as set_store_value, d as add_attribute, l as createEventDispatcher, g as each } from "../../../../chunks/index3.js";
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"threejs svelte-1ra4uw1"}">${validate_component(Canvas, "Canvas").$$render($$result, {}, {}, {
    default: () => {
      return `${validate_component(PerspectiveCamera2, "PerspectiveCamera").$$render($$result, { position: { x: 5, y: 2, z: 5 }, fov: 25 }, {}, {
        default: () => {
          return `${validate_component(OrbitControls2, "OrbitControls").$$render($$result, { autoRotate: true, enableDamping: true }, {}, {})}`;
        }
      })}
