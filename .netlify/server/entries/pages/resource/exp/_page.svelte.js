import {
	...
	y as set_store_value,
	d as add_attribute,
	l as createEventDispatcher,
	g as each
} from '../../../../chunks/index3.js';
import { d as derived, w as writable, r as readable } from '../../../../chunks/index2.js';
const REVISION = '148';
...
class Interpolant {
	constructor(parameterPositions, sampleValues, sampleSize, resultBuffer) {
		...
		this._cachedIndex = 0;
		this.resultBuffer =
			resultBuffer !== void 0 ? resultBuffer : new sampleValues.constructor(sampleSize);
...
const Object3DInstance = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	do {
		...
		{
			{
				if (visible !== void 0) getObject().visible = visible;
				if (castShadow !== void 0) getObject().castShadow = castShadow;
				if (receiveShadow !== void 0) getObject().receiveShadow = receiveShadow;
				if (frustumCulled !== void 0) getObject().frustumCulled = frustumCulled;
				if (renderOrder !== void 0) getObject().renderOrder = renderOrder;
				if (userData !== void 0) {
		...
		$$rendered = `${validate_component(LayerableObject, 'LayerableObject').$$render(
			$$result,
			{ object },
			{},
			{}
...
${validate_component(DisposableObject, 'DisposableObject').$$render(
	$$result,
	{ object, dispose },
	{},
	{
		default: () => {
			return `${validate_component(SceneGraphObject, 'SceneGraphObject').$$render(
				$$result,
				{ object },
				{},
				{
...
const PerspectiveCamera2 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	if ($$props.useCamera === void 0 && $$bindings.useCamera && useCamera !== void 0)
		$$bindings.useCamera(useCamera);
	if ($$props.near === void 0 && $$bindings.near && near !== void 0) $$bindings.near(near);
	if ($$props.far === void 0 && $$bindings.far && far !== void 0) $$bindings.far(far);
	if ($$props.fov === void 0 && $$bindings.fov && fov !== void 0) $$bindings.fov(fov);
	if ($$props.camera === void 0 && $$bindings.camera && camera !== void 0)
		$$bindings.camera(camera);
	let $$settled;
	let $$rendered;
	do {
		...
		{
			{
				if (near !== void 0) camera.near = near;
				if (far !== void 0) camera.far = far;
				if (fov !== void 0) camera.fov = fov;
				camera.updateProjectionMatrix();
...
const OrbitControls2 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	if (
		$$props.autoRotateSpeed === void 0 &&
		$$bindings.autoRotateSpeed &&
		autoRotateSpeed !== void 0
	)
	...
	if (
		$$props.maxAzimuthAngle === void 0 &&
		$$bindings.maxAzimuthAngle &&
		maxAzimuthAngle !== void 0
	)
	...
	if (
		$$props.minAzimuthAngle === void 0 &&
		$$bindings.minAzimuthAngle &&
		minAzimuthAngle !== void 0
	)
	...
	if (
		$$props.screenSpacePanning === void 0 &&
		$$bindings.screenSpacePanning &&
		screenSpacePanning !== void 0
	)
	...
	{
		{
			if (autoRotate !== void 0) controls.autoRotate = autoRotate;
			if (autoRotateSpeed !== void 0) controls.autoRotateSpeed = autoRotateSpeed;
			if (dampingFactor !== void 0) controls.dampingFactor = dampingFactor;
			if (enableDamping !== void 0) controls.enableDamping = enableDamping;
			if (enabled !== void 0) controls.enabled = enabled;
			if (enablePan !== void 0) controls.enablePan = enablePan;
			if (enableRotate !== void 0) controls.enableRotate = enableRotate;
			if (enableZoom !== void 0) controls.enableZoom = enableZoom;
			if (keyPanSpeed !== void 0) controls.keyPanSpeed = keyPanSpeed;
			if (keys !== void 0) controls.keys = keys;
			if (maxAzimuthAngle !== void 0) controls.maxAzimuthAngle = maxAzimuthAngle;
			if (maxDistance !== void 0) controls.maxDistance = maxDistance;
			if (maxPolarAngle !== void 0) controls.maxPolarAngle = maxPolarAngle;
			if (maxZoom !== void 0) controls.maxZoom = maxZoom;
			if (minAzimuthAngle !== void 0) controls.minAzimuthAngle = minAzimuthAngle;
			if (minDistance !== void 0) controls.minDistance = minDistance;
			if (minPolarAngle !== void 0) controls.minPolarAngle = minPolarAngle;
			if (minZoom !== void 0) controls.minZoom = minZoom;
			if (mouseButtons !== void 0) controls.mouseButtons = mouseButtons;
			if (panSpeed !== void 0) controls.panSpeed = panSpeed;
			if (rotateSpeed !== void 0) controls.rotateSpeed = rotateSpeed;
			if (screenSpacePanning !== void 0) controls.screenSpacePanning = screenSpacePanning;
			if (touches !== void 0) controls.touches = touches;
	...
	$$unsubscribe_parent();
	return `${validate_component(DisposableObject, 'DisposableObject').$$render(
		$$result,
		{ dispose, object: controls },
		{},
		{}
	)}
...
${validate_component(TransformableObject, 'TransformableObject').$$render(
	$$result,
	{ object: targetObject, position: target },
	{},
	{}
)}`;
});
...
const LightInstance = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	do {
		...
		{
			{
				if (intensity !== void 0) light.intensity = intensity;
				if (color !== void 0) light.color = convertColorRepresentationToColor(color, $linear);
...
const AmbientLight2 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	let { position = void 0 } = $$props;
	let { scale = void 0 } = $$props;
	let { rotation = void 0 } = $$props;
	let { lookAt = void 0 } = $$props;
		...
		switch (lightDef.type) {
			...
			case 'spot':
				...
				lightDef.spot.innerConeAngle =
					lightDef.spot.innerConeAngle !== void 0 ? lightDef.spot.innerConeAngle : 0;
...
class GLTFParser {
	...
	loadMaterial(materialIndex) {
		...
		if (materialExtensions[EXTENSIONS.KHR_MATERIALS_UNLIT]) {
			...
			materialParams.metalness =
				metallicRoughness.metallicFactor !== void 0 ? metallicRoughness.metallicFactor : 1;
			materialParams.roughness =
				metallicRoughness.roughnessFactor !== void 0 ? metallicRoughness.roughnessFactor : 1;
	...
	loadAnimation(animationIndex) {
		...
		for (let i = 0, il = animationDef.channels.length; i < il; i++) {
			...
			const input =
				animationDef.parameters !== void 0 ? animationDef.parameters[sampler.input] : sampler.input;
			const output =
...
class Ii {
	constructor(t2, e, n2, i) {
		(this._dataView = new DataView(t2.buffer, t2.byteOffset + e, n2)),
	...
	_scan(t2, e = 0) {
		...
		return (
			i < t2 && this._offset++,
			new Uint8Array(this._dataView.buffer, this._dataView.byteOffset + n2, i)
		);
	}
}
...
function Ei(t2) {
	return 'undefined' != typeof TextDecoder
		? new TextDecoder().decode(t2)
		: Buffer.from(t2).toString('utf8');
}
function Pi(t2) {
	...
	const n2 = new Si(),
		...
		s = new Ii(t2, Ti.length, i, true);
	(n2.vkFormat = s._nextUint32()),
		(n2.typeSize = s._nextUint32()),
		(n2.pixelWidth = s._nextUint32()),
		(n2.pixelHeight = s._nextUint32()),
		(n2.pixelDepth = s._nextUint32()),
		(n2.layerCount = s._nextUint32()),
		(n2.faceCount = s._nextUint32());
	...
	const r = s._nextUint32(),
		...
		U = s._nextUint64(),
		c = s._nextUint64(),
		h = new Ii(t2, Ti.length + i, 3 * a * 8, true);
	for (let e2 = 0; e2 < a; e2++)
		n2.levels.push({
			levelData: new Uint8Array(t2.buffer, t2.byteOffset + h._nextUint64(), h._nextUint64()),
			uncompressedByteLength: h._nextUint64()
		});
	const _ = new Ii(t2, r, o, true),
		p2 = {
	...
	for (let t3 = 0; t3 < g2; t3++) {
		...
		64 & e2.channelType
			? ((e2.sampleLower = _._nextInt32()), (e2.sampleUpper = _._nextInt32()))
			: ((e2.sampleLower = _._nextUint32()), (e2.sampleUpper = _._nextUint32())),
			(p2.samples[t3] = e2);
	}
	(n2.dataFormatDescriptor.length = 0), n2.dataFormatDescriptor.push(p2);
	const y = new Ii(t2, l, f, true);
	for (; y._offset < f; ) {
		const t3 = y._nextUint32(),
			e2 = y._scan(t3),
			i2 = Ei(e2),
			s2 = y._scan(t3 - e2.byteLength);
		(n2.keyValue[i2] = i2.match(/^ktx/i) ? Ei(s2) : s2),
			y._offset % 4 && y._skip(4 - (y._offset % 4));
	}
	if (c <= 0) return n2;
	const x2 = new Ii(t2, U, c, true),
		u = x2._nextUint16(),
		b = x2._nextUint16(),
		d = x2._nextUint32(),
		m = x2._nextUint32(),
	...
	const L = U + x2._offset,
		A2 = L + d,
		k = A2 + m,
		v = k + w,
		S = new Uint8Array(t2.buffer, t2.byteOffset + L, d),
		I2 = new Uint8Array(t2.buffer, t2.byteOffset + A2, m),
		O = new Uint8Array(t2.buffer, t2.byteOffset + k, w),
		T = new Uint8Array(t2.buffer, t2.byteOffset + v, D);
	return (
		(n2.globalData = {
			endpointCount: u,
			selectorCount: b,
...
class Q {
			...
			((A =
				'undefined' != typeof fetch
					? fetch('data:application/wasm;base64,' + C)
							.then((A2) => A2.arrayBuffer())
							.then((A2) => WebAssembly.instantiate(A2, g))
							.then(this._init)
					: WebAssembly.instantiate(Buffer.from(C, 'base64'), g).then(this._init)),
			A)
		);
	}
	_init(A2) {
	...
	decode(A2, g2 = 0) {
		...
		const Q2 = A2.byteLength,
			C2 = I.exports.malloc(Q2);
		B.set(A2, C2), (g2 = g2 || Number(I.exports.ZSTD_findDecompressedSize(C2, Q2)));
		const E = I.exports.malloc(g2),
			i = I.exports.ZSTD_decompress(E, g2, C2, Q2),
			D = B.slice(E, E + i);
...
class KTX2Loader extends Loader {
	...
	_createTextureFrom(transcodeResult, container) {
		const { mipmaps, width, height, format, type, error, dfdTransferFn, dfdFlags } =
			transcodeResult;
		...
		switch (message.type) {
			...
			case 'transcode':
				transcoderPending.then(() => {
					try {
						const { width, height, hasAlpha, mipmaps, format, dfdTransferFn, dfdFlags } = transcode(
							message.buffer
						);
						const buffers = [];
...
const GLTF = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	if (
		$$props.dracoDecoderPath === void 0 &&
		$$bindings.dracoDecoderPath &&
		dracoDecoderPath !== void 0
	)
	...
	if (
		$$props.ktxTranscoderPath === void 0 &&
		$$bindings.ktxTranscoderPath &&
		ktxTranscoderPath !== void 0
	)
	...
	if ($$props.interactive === void 0 && $$bindings.interactive && interactive !== void 0)
		$$bindings.interactive(interactive);
	if ($$props.gltf === void 0 && $$bindings.gltf && gltf !== void 0) $$bindings.gltf(gltf);
	...
	do {
		...
		{
			{
				if (scene) {
					scene.traverse((obj) => {
						if (castShadow !== void 0) obj.castShadow = castShadow;
						if (receiveShadow !== void 0) obj.receiveShadow = receiveShadow;
						if (frustumCulled !== void 0) obj.frustumCulled = frustumCulled;
						if (renderOrder !== void 0) obj.renderOrder = renderOrder;
					});
				}
			}
		}
        ...
        ${validate_component(LayerableObject, 'LayerableObject').$$render(
					$$result,
					{ object: node },
					{},
					{}
        ...
        ${
					node.type === 'Mesh' || node.type === 'SkinnedMesh'
						? `${validate_component(InteractiveObject, 'InteractiveObject').$$render(
								$$result,
								{ object: node, interactive, ignorePointer },
								{},
								{}
						  )}`
						: ``
...
${
	materials
		? `${each(Object.values(materials), (material) => {
				return `${validate_component(DisposableObject, 'DisposableObject').$$render(
					$$result,
...
${
	scene
		? `${validate_component(Object3DInstance, 'Object3DInstance').$$render(
				$$result,
				{
					object: scene,
					position,
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	$$result.css.add(css);
	return `<div class="${'threejs svelte-1ra4uw1'}">${validate_component(Canvas, 'Canvas').$$render(
		$$result,
		{},
		{},
		{
			default: () => {
				return `${validate_component(PerspectiveCamera2, 'PerspectiveCamera').$$render(
					$$result,
					{ position: { x: 5, y: 2, z: 5 }, fov: 25 },
					{},
					{
						default: () => {
							return `${validate_component(OrbitControls2, 'OrbitControls').$$render(
								$$result,
								{ autoRotate: true, enableDamping: true },
								{},
								{}
							)}`;
						}
		...
		${validate_component(AmbientLight2, 'AmbientLight').$$render($$result, {}, {}, {})}
