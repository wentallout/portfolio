import { c as create_ssr_component, b as add_attribute, f as each, v as validate_component, d as spread, e as escape_object } from "../../../chunks/index.js";
...
const css$3 = {
  code: ".book-container.svelte-hb8xou.svelte-hb8xou{display:flex;align-items:center;justify-content:center;perspective:600px}@keyframes svelte-hb8xou-initAnimation{0%{transform:rotateY(0deg)}100%{transform:rotateY(-30deg)}}.book.svelte-hb8xou.svelte-hb8xou{width:200px;height:300px;position:relative;transform-style:preserve-3d;transform:rotateY(-30deg);transition:1s ease;animation:1s ease 0s 1 svelte-hb8xou-initAnimation}.book.svelte-hb8xou.svelte-hb8xou:hover{transform:rotateY(0deg)}.book.svelte-hb8xou>.svelte-hb8xou:first-child{position:absolute;top:0;left:0;width:200px;height:300px;transform:translateZ(25px);background-color:#01060f;border-radius:0 2px 2px 0;box-shadow:5px 5px 20px #666}.book.svelte-hb8xou.svelte-hb8xou::before{position:absolute;content:' ';left:0;top:3px;width:48px;height:294px;transform:translateX(172px) rotateY(90deg);background:linear-gradient(\r\n			90deg,\r\n			#fff 0%,\r\n			#f9f9f9 5%,\r\n			#fff 10%,\r\n			#f9f9f9 15%,\r\n			#fff 20%,\r\n			#f9f9f9 25%,\r\n			#fff 30%,\r\n			#f9f9f9 35%,\r\n			#fff 40%,\r\n			#f9f9f9 45%,\r\n			#fff 50%,\r\n			#f9f9f9 55%,\r\n			#fff 60%,\r\n			#f9f9f9 65%,\r\n			#fff 70%,\r\n			#f9f9f9 75%,\r\n			#fff 80%,\r\n			#f9f9f9 85%,\r\n			#fff 90%,\r\n			#f9f9f9 95%,\r\n			#fff 100%\r\n		)}.book.svelte-hb8xou.svelte-hb8xou::after{position:absolute;top:0;left:0;content:' ';width:200px;height:300px;transform:translateZ(-25px);background-color:var(--neutral-900);border-radius:0 2px 2px 0;box-shadow:-10px 0 50px 10px #666}",
  map: null
};
const CoolBook = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<a class="${"book-container svelte-hb8xou"}"${add_attribute("href", bookUrl, 0)} target="${"_blank"}" rel="${"noreferrer noopener"}"><div class="${"book svelte-hb8xou"}"><img loading="${"lazy"}" decoding="${"async"}"${add_attribute("alt", alt, 0)}${add_attribute("src", imgUrl, 0)} class="${"svelte-hb8xou"}"></div>
</a>`;
});
const BookGallery_svelte_svelte_type_style_lang = "";
const css$2 = {
  code: ".book.svelte-ky8vu6{width:100%;display:flex;flex-direction:row;flex-wrap:wrap;gap:var(--space-xl)}",
  map: null
};
  ...
  let books = [
    {
      ...
      bookUrl: "https://1drv.ms/b/s!Ahis-4qg6dsEdTm7ECJXBuoqoxw"
    },
    {
      name: "Design Manual",
      imgUrl: DesignManual,
      bookUrl: "https://1drv.ms/b/s!Ahis-4qg6dsEgQEq8MWATB9SsYE_?e=eAWtz4"
    },
    {
      name: "NoBSGuideUX",
      imgUrl: NoBSGuideUX,
      bookUrl: "https://1drv.ms/b/s!Ahis-4qg6dsEdpmKJyycIRPpPlA"
    },
    {
      name: "Sprint",
      imgUrl: Sprint,
      bookUrl: "https://1drv.ms/b/s!Ahis-4qg6dsEd0lfpvdH9cTtzRk"
    }
  ];
  $$result.css.add(css$2);
  return `<div class="${"book svelte-ky8vu6"}">${each(books, (book) => {
...
const css = {
  code: ".section-description.svelte-1cva6kc{max-width:60ch;text-align:left;margin-bottom:var(--space-s)}",
  map: null
};
...
<section>${validate_component(SectionTitle, "SectionTitle").$$render($$result, { sectionTitle: "User Research" }, {}, {
	...
	<p class="${"section-description small-text svelte-1cva6kc"}">User research helps you understand user behaviors, needs, and motivations through various
