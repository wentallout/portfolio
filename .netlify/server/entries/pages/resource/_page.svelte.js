import { c as create_ssr_component, o as compute_rest_props, l as createEventDispatcher, s as setContext, p as onDestroy, e as spread, q as escape_attribute_value, f as escape_object, d as add_attribute, t as is_void, w as tick, k as getContext, v as validate_component, g as each, h as escape } from "../../../chunks/index3.js";
...
const ResourceCard = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(ExLink, "ExLink").$$render($$result, { href, ariaLabel: name }, {}, {
    default: () => {
      return `<div class="${"tool svelte-mozove"}"><h2 class="${"tool__name base-text svelte-mozove"}">${escape(name)}</h2>
