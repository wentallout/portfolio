import { c as create_ssr_component, s as setContext, j as getContext, h as subscribe, g as escape, d as spread, e as escape_object, b as add_attribute, v as validate_component } from "../../../chunks/index.js";
...
const BookCard = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"book svelte-118bcm9"}"><img loading="${"lazy"}" decoding="${"async"}" height="${"250"}" width="${"175"}" class="${"book__thumbnail svelte-118bcm9"}" alt="${"book cover"}"${add_attribute("src", thumbnailUrl, 0)}>
	...
	<div class="${"book__info svelte-118bcm9"}"><div class="${"book-title base-text svelte-118bcm9"}">${escape(bookTitle)}</div>
		...
		<a class="${"btn-download svelte-118bcm9"}" target="${"_blank"}"${add_attribute("href", url, 0)}>${validate_component(Button, "Button").$$render(
    $$result,
    {
      label: "Download",
...
${validate_component(SectionTitle, "SectionTitle").$$render($$result, { sectionTitle: "Book" }, {}, {
    default: ({ sectionIcon }) => {
