...
const css = {
  code: ".result.svelte-roeu49{color:var(--neutral-700);font-family:var(--fancy-font);font-weight:300;margin-bottom:var(--space-m)}",
  map: null
};
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.data === void 0 && $$bindings.data && data !== void 0)
    $$bindings.data(data);
  $$result.css.add(css);
  return `<p class="${"result large-text svelte-roeu49"}">Posts about <strong>${escape(data.category)}</strong> :</p>
