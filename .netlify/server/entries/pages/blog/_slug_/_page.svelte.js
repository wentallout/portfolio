...
<article class="${'info svelte-13xqe99'}">${
		data.categories.length
			? `<div class="${'category svelte-13xqe99'}">${each(data.categories, (category) => {
					return `<a class="${'content-tag svelte-13xqe99'}" href="${
						'/blog/category/' + escape(category, true)
	...
	<div class="${'date small-text svelte-13xqe99'}">Published: ${validate_component(
		Time,
		'Time'
