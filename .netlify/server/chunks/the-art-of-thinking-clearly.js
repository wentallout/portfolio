...
const The_art_of_thinking_clearly = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<nav class="${"toc"}"><ol class="${"toc-level toc-level-1"}"><li class="${"toc-item toc-item-h2"}"><a class="${"toc-link toc-link-h2"}" href="${"#4-if-50-million-people-say-something-foolish-it-is-still-foolish"}">4. if 50 million people say something foolish, it is still foolish</a></li><li class="${"toc-item toc-item-h2"}"><a class="${"toc-link toc-link-h2"}" href="${"#5-why-you-should-forget-the-past"}">5. why you should forget the past</a></li><li class="${"toc-item toc-item-h2"}"><a class="${"toc-link toc-link-h2"}" href="${"#6-dont-accept-free-drinks"}">6. don\u2019t accept free drinks</a></li><li class="${"toc-item toc-item-h2"}"><a class="${"toc-link toc-link-h2"}" href="${"#7-beware-the-special-case"}">7. beware the special case</a></li><li class="${"toc-item toc-item-h2"}"><a class="${"toc-link toc-link-h2"}" href="${"#8-murder-your-darlings"}">8. murder your darlings</a></li><li class="${"toc-item toc-item-h2"}"><a class="${"toc-link toc-link-h2"}" href="${"#9-dont-bow-to-authority"}">9. don\u2019t bow to authority</a></li><li class="${"toc-item toc-item-h2"}"><a class="${"toc-link toc-link-h2"}" href="${"#leave-your-supermodel-friends-at-home"}">LEAVE YOUR SUPERMODEL FRIENDS AT HOME</a></li><li class="${"toc-item toc-item-h2"}"><a class="${"toc-link toc-link-h2"}" href="${"#11-why-we-prefer-a-wrong-map-to-no-map-at-all"}">11. why we prefer a wrong map to no map at all</a></li><li class="${"toc-item toc-item-h2"}"><a class="${"toc-link toc-link-h2"}" href="${"#12-why-no-pain-no-gain-should-set-alarm-bells-ringing"}">12. WHY \u2018NO PAIN, NO GAIN\u2019 SHOULD SET ALARM BELLS RINGING</a></li><li class="${"toc-item toc-item-h2"}"><a class="${"toc-link toc-link-h2"}" href="${"#13-even-true-stories-are-fairytales"}">13. EVEN TRUE STORIES ARE FAIRYTALES</a></li><li class="${"toc-item toc-item-h2"}"><a class="${"toc-link toc-link-h2"}" href="${"#14-why-you-should-keep-a-diary"}">14. WHY YOU SHOULD KEEP A DIARY</a></li><li class="${"toc-item toc-item-h2"}"><a class="${"toc-link toc-link-h2"}" href="${"#15-why-you-systematically-overestimate-your-knowledge-and-abilities"}">15. WHY YOU SYSTEMATICALLY OVERESTIMATE YOUR KNOWLEDGE AND ABILITIES</a></li><li class="${"toc-item toc-item-h2"}"><a class="${"toc-link toc-link-h2"}" href="${"#16-dont-take-news-anchors-seriously"}">16. DON\u2019T TAKE NEWS ANCHORS SERIOUSLY</a></li><li class="${"toc-item toc-item-h2"}"><a class="${"toc-link toc-link-h2"}" href="${"#17-you-control-less-than-you-think"}">17. YOU CONTROL LESS THAN YOU THINK</a></li><li class="${"toc-item toc-item-h2"}"><a class="${"toc-link toc-link-h2"}" href="${"#18-never-pay-your-lawyer-by-the-hour"}">18. never pay your lawyer by the hour</a></li><li class="${"toc-item toc-item-h2"}"><a class="${"toc-link toc-link-h2"}" href="${"#19-the-dubious-efficacy-of-doctors-consultants-and-psychotherapists"}">19. THE DUBIOUS EFFICACY OF DOCTORS, CONSULTANTS AND PSYCHOTHERAPISTS</a></li><li class="${"toc-item toc-item-h2"}"><a class="${"toc-link toc-link-h2"}" href="${"#20-never-judge-a-decision-by-its-outcome"}">20. never judge a decision by its outcome</a></li><li class="${"toc-item toc-item-h2"}"><a class="${"toc-link toc-link-h2"}" href="${"#22-less-is-more"}">22. less is more</a></li><li class="${"toc-item toc-item-h2"}"><a class="${"toc-link toc-link-h2"}" href="${"#22-you-like-me-you-really-really-like-me"}">22. you like me, you really really like me</a></li><li class="${"toc-item toc-item-h2"}"><a class="${"toc-link toc-link-h2"}" href="${"#23-dont-cling-to-things"}">23. DON\u2019T CLING TO THINGS</a></li><li class="${"toc-item toc-item-h2"}"><a class="${"toc-link toc-link-h2"}" href="${"#24-the-inevitability-of-unlikely-events-coincidence"}">24. THE INEVITABILITY OF UNLIKELY EVENTS: Coincidence</a></li><li class="${"toc-item toc-item-h2"}"><a class="${"toc-link toc-link-h2"}" href="${"#25-the-calamity-of-conformity"}">25. THE CALAMITY OF CONFORMITY</a></li><li class="${"toc-item toc-item-h2"}"><a class="${"toc-link toc-link-h2"}" href="${"#26-why-youll-soon-be-playing-megatrillions"}">26. WHY YOU\u2019LL SOON BE PLAYING MEGATRILLIONS</a></li><li class="${"toc-item toc-item-h2"}"><a class="${"toc-link toc-link-h2"}" href="${"#27-scarcity-error"}">27. Scarcity Error</a></li><li class="${"toc-item toc-item-h2"}"><a class="${"toc-link toc-link-h2"}" href="${"#28-base-rate-neglect"}">28. Base-Rate Neglect</a></li><li class="${"toc-item toc-item-h2"}"><a class="${"toc-link toc-link-h2"}" href="${"#29-gamblers-fallacy"}">29. Gambler\u2019s Fallacy</a></li><li class="${"toc-item toc-item-h2"}"><a class="${"toc-link toc-link-h2"}" href="${"#30-the-anchor"}">30 The Anchor</a></li></ol></nav>

<h2 id="${"4-if-50-million-people-say-something-foolish-it-is-still-foolish"}">4. if 50 million people say something foolish, it is still foolish</h2>
...
<h2 id="${"5-why-you-should-forget-the-past"}">5. why you should forget the past</h2>
...
I sometimes go overboard on the subject, itself an error called d\xE9formation
...
<h2 id="${"6-dont-accept-free-drinks"}">6. don\u2019t accept free drinks</h2>
<p>Reciprocity
...
<h2 id="${"7-beware-the-special-case"}">7. beware the special case</h2>
...
the next chapter.</p>
<h2 id="${"8-murder-your-darlings"}">8. murder your darlings</h2>
...
imperative.</p>
<h2 id="${"9-dont-bow-to-authority"}">9. don\u2019t bow to authority</h2>
<p>Authority Bias</p>
...
<h2 id="${"leave-your-supermodel-friends-at-home"}">LEAVE YOUR SUPERMODEL FRIENDS AT HOME</h2>
<p>Contrast Effect</p>
...
friends.</p>
<h2 id="${"11-why-we-prefer-a-wrong-map-to-no-map-at-all"}">11. why we prefer a wrong map to no map at all</h2>
...
<h2 id="${"12-why-no-pain-no-gain-should-set-alarm-bells-ringing"}">12. WHY \u2018NO PAIN, NO GAIN\u2019 SHOULD SET ALARM BELLS RINGING</h2>
...
<h2 id="${"13-even-true-stories-are-fairytales"}">13. EVEN TRUE STORIES ARE FAIRYTALES</h2>
<p>Story Bias</p>
...
<h2 id="${"14-why-you-should-keep-a-diary"}">14. WHY YOU SHOULD KEEP A DIARY</h2>
<p>Hindsight Bias</p>
...
<h2 id="${"15-why-you-systematically-overestimate-your-knowledge-and-abilities"}">15. WHY YOU SYSTEMATICALLY OVERESTIMATE YOUR KNOWLEDGE AND ABILITIES</h2>
...
but they are lost</p>
<h2 id="${"16-dont-take-news-anchors-seriously"}">16. DON\u2019T TAKE NEWS ANCHORS SERIOUSLY</h2>
...
competence.\u2019</p>
<p>In conclusion: be on the lookout for chauffeur knowledge. Do not confuse the company spokesperson, the ringmaster, the newscaster, the schmoozer, the verbiage vendor or the clich\xE9 generator with those who possess true knowledge. How do you recognise the difference There is a clear indicator: true experts recognise the limits of what they know and what they do not know. If they find themselves outside their circle of competence, they keep quiet or simply say, \u2018I don\u2019t know.\u2019 This they utter unapologetically, even with a certain pride. From chauffeurs, we hear every line except this.</p>
<h2 id="${"17-you-control-less-than-you-think"}">17. YOU CONTROL LESS THAN YOU THINK</h2>
...
<h2 id="${"18-never-pay-your-lawyer-by-the-hour"}">18. never pay your lawyer by the hour</h2>
...
<h2 id="${"19-the-dubious-efficacy-of-doctors-consultants-and-psychotherapists"}">19. THE DUBIOUS EFFICACY OF DOCTORS, CONSULTANTS AND PSYCHOTHERAPISTS</h2>
...
<h2 id="${"20-never-judge-a-decision-by-its-outcome"}">20. never judge a decision by its outcome</h2>
<p>Outcome Bias</p>
...
<h2 id="${"22-less-is-more"}">22. less is more</h2>
...
<h2 id="${"22-you-like-me-you-really-really-like-me"}">22. you like me, you really really like me</h2>
<p>Liking Bias</p>
...
<h2 id="${"23-dont-cling-to-things"}">23. DON\u2019T CLING TO THINGS</h2>
...
<h2 id="${"24-the-inevitability-of-unlikely-events-coincidence"}">24. THE INEVITABILITY OF UNLIKELY EVENTS: Coincidence</h2>
...
<h2 id="${"25-the-calamity-of-conformity"}">25. THE CALAMITY OF CONFORMITY</h2>
<p>Groupthink</p>
...
<h2 id="${"26-why-youll-soon-be-playing-megatrillions"}">26. WHY YOU\u2019LL SOON BE PLAYING MEGATRILLIONS</h2>
...
<h2 id="${"27-scarcity-error"}">27. Scarcity Error</h2>
...
<h2 id="${"28-base-rate-neglect"}">28. Base-Rate Neglect</h2>
...
<h2 id="${"29-gamblers-fallacy"}">29. Gambler\u2019s Fallacy</h2>
...
<p>But we\u2019ve just come across another pitfall: the classic d\xE9formation
...
<h2 id="${"30-the-anchor"}">30 The Anchor</h2>
