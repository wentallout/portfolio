...
const ProjectCard = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  return `<div class="${"project svelte-16wofxr"}"><img class="${"project__thumbnail svelte-16wofxr"}"${add_attribute("thumbnail", thumbnail, 0)} alt="${"thumbnail"}">

	<div class="${"project__info svelte-16wofxr"}"><div class="${"info__project-name large-text svelte-16wofxr"}">${escape(projectName)}</div>
		...
		<div class="${"info__btn svelte-16wofxr"}"><a class="${"btn__anchor svelte-16wofxr"}"${add_attribute("href", linkToDetail, 0)}>${validate_component(Button, "Button").$$render(
    $$result,
    {
      label: "Read",
    ...
    {}
			...
			<a class="${"btn__anchor svelte-16wofxr"}" rel="${"external noreferrer noopener"}" target="${"_blank"}"${add_attribute("href", linkToFigma, 0)}>${validate_component(Button, "Button").$$render(
    $$result,
    {
