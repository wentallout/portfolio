...
${$$result.head += `<!-- HEAD_svelte-ufbs9k_START --><style>:root{--brand-color:#e4543b}.markdown h2,.markdown h3{color:#e4543b!important;color:var(--brand-color)!important}.markdown h2:before,.markdown h3:before{background-color:#e4543b;background-color:var(--brand-color)}</style><!-- HEAD_svelte-ufbs9k_END -->`, ""}
