...
const Caret_circle_left = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<svg${spread(
    [
    ...
    {}
  )}><!-- HTML_TAG_START -->${`<path fill="currentColor" d="M128 24a104 104 0 1 0 104 104A104.2 104.2 0 0 0 128 24Zm0 192a88 88 0 1 1 88-88a88.1 88.1 0 0 1-88 88Zm21.4-118.1L116 128l33.4 30.1a8 8 0 0 1 .5 11.3a7.9 7.9 0 0 1-5.9 2.6a8.2 8.2 0 0 1-5.4-2.1l-40-36a8 8 0 0 1 0-11.8l40-36a8 8 0 1 1 10.8 11.8Z"/>`}<!-- HTML_TAG_END --></svg>`;
});
const Caret_circle_right = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<svg${spread(
    [
      { preserveAspectRatio: "xMidYMid meet" },
      { viewBox: "0 0 256 256" },
    ...
    {}
  )}><!-- HTML_TAG_START -->${`<path fill="currentColor" d="M128 24a104 104 0 1 0 104 104A104.2 104.2 0 0 0 128 24Zm0 192a88 88 0 1 1 88-88a88.1 88.1 0 0 1-88 88Zm33.4-93.9a8 8 0 0 1 0 11.8l-40 36a8.2 8.2 0 0 1-5.4 2.1a7.9 7.9 0 0 1-5.9-2.6a8 8 0 0 1 .5-11.3L144 128l-33.4-30.1a8 8 0 0 1 10.8-11.8Z"/>`}<!-- HTML_TAG_END --></svg>`;
});
const swiperBundle_min = "";
const SwiperContainer_svelte_svelte_type_style_lang = "";
const css$1 = {
  code: ".swiper-btn.svelte-1mfqv4g{display:flex;flex-direction:row}.swiper-prev.svelte-1mfqv4g,.swiper-next.svelte-1mfqv4g{width:50px;height:50px;cursor:pointer}",
  map: null
};
const SwiperContainer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$1);
  return `<div class="${"swiper-btn svelte-1mfqv4g"}"><div class="${"swiper-prev svelte-1mfqv4g"}">${validate_component(Caret_circle_left, "CaretCircleLeft").$$render($$result, { width: "40", height: "40" }, {}, {})}</div>
	<div class="${"swiper-next svelte-1mfqv4g"}">${validate_component(Caret_circle_right, "CaretCircleRight").$$render($$result, { width: "40", height: "40" }, {}, {})}</div></div>
...
const reza_svx_svelte_type_style_lang = "";
const css = {
  code: ":root{--brand-color:#E4543B !important}",
  map: null
};
const metadata = {
...
<strong><p>\u2666 Recommend the most trendy restaurants</p>
<p>\u2666 Show you its menu, price and past reviews,</p>
<p>\u2666 Let you reserve a table when it\u2019s available and then remind you when it\u2019s time and guide you there.</p></strong>
...
<h3>Phase Four - Prototype</h3>
<p>In this phase we need to create an interactive design that will be tested by potential users in phase 5.</p>
...
<div style="${"left: 0; width: 100%; height: 450px; position: relative;"}"><iframe alt="${"figma prototype"}" style="${"border: 1px solid rgba(0, 0, 0, 0.1);"}" width="${"100%"}" height="${"450"}" src="${"https://www.figma.com/embed?embed_host=share&url=https%3A%2F%2Fwww.figma.com%2Fproto%2FowUrwidb8hZbdmruKhMtyS%2FREZA%253A-Restaurant-Reservation-App%3Fpage-id%3D2%253A9%26node-id%3D275%253A5365%26viewport%3D549%252C-598%252C0.24%26scaling%3Dscale-down%26starting-point-node-id%3D275%253A5365"}" allowfullscreen></iframe></div>
<h3>Phase Five - Test</h3>
<p>Getting feedback from real users in the testing phase will give me a chance to redesign and maximize the performance of my design</p>
<p>We skipped this phase due to time limitation but I\u2019ve found a Remote Usability Testing platform that can help with this: <a href="${"https://maze.co/"}" rel="${"nofollow"}">Maze</a></p>
<h2>Conclusion</h2>
