...
${$$result.head += `<!-- HEAD_svelte-k5xlvh_START --><style>:root{--brand-color:#e4543b}.markdown h2,.markdown h3,.markdown h4{color:var(--brand-color)!important}.markdown h2:before,.markdown h3:before,.markdown h4:before{background-color:var(--brand-color)}</style><!-- HEAD_svelte-k5xlvh_END -->`, ""}


<h2 id="${"overview"}">overview</h2>
${validate_component(Image, "Image").$$render($$result, { src: thumbnail, alt: "reza thumbnail" }, {}, {})}
<ul><li>Project Name: Reza</li>
<li>Project Type: Concept Mobile App</li>
<li>Role: UI/UX Designer, Team Leader</li>
<li>Software: Figma</li></ul>
