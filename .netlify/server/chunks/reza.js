...
${validate_component(Image, 'Image').$$render(
	$$result,
	{ src: userResearch, alt: 'user research' },
	{},
	{}
)}
...
${validate_component(Image, 'Image').$$render(
	$$result,
	{ src: discord, alt: 'discord screen' },
	{},
	{}
)}
...
${validate_component(Image, 'Image').$$render(
	$$result,
	{ src: lofi, alt: 'low fidelity wireframe' },
	{},
	{}
)}
...
${validate_component(Image, 'Image').$$render(
	$$result,
	{ src: ds1, alt: 'design system' },
	{},
	{}
)}   
${validate_component(Image, 'Image').$$render(
	$$result,
	{ src: ds2, alt: 'design system' },
	{},
	{}
)} 
...
${validate_component(Image, 'Image').$$render(
	$$result,
	{ src: homeScreen, alt: 'home screen UI' },
	{},
	{}
)}
...
${validate_component(Image, 'Image').$$render(
	$$result,
	{ src: detailScreen, alt: 'detail screen' },
	{},
	{}
)}
...
${validate_component(Image, 'Image').$$render(
	$$result,
	{ src: redesign2, alt: 'the solution' },
	{},
	{}
)}
...
export { Reza as default, metadata };
