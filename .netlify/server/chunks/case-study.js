...
<h2 id="${"purpose-of-a-case-study"}"><a href="${"#purpose-of-a-case-study"}">Purpose of a case Study</a></h2>
...
<h2 id="${"how-to-document-your-case-study"}"><a href="${"#how-to-document-your-case-study"}">How to document your case study</a></h2>`;
});
export {
