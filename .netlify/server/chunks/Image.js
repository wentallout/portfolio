...
const css$5 = {
  code: "div.svelte-lightbox-header.svelte-1qg5r72{align-items:center;display:flex;height:3rem;justify-content:flex-end;width:auto}div.svelte-lightbox-header.fullscreen.svelte-1qg5r72{left:0;position:fixed;right:0;top:0;z-index:5}button.svelte-1qg5r72{background:transparent;border:none;color:#fff;font-size:3rem}button.svelte-1qg5r72:hover{color:#d3d3d3;cursor:pointer}button.svelte-1qg5r72:active{background-color:transparent}button.fullscreen.svelte-1qg5r72{filter:drop-shadow(0 0 5px black) drop-shadow(0 0 10px black)}",
  map: null
};
...
const css$3 = {
  code: "div.svelte-lightbox-footer.svelte-16koabs{color:#fff;height:auto;position:absolute;text-align:left;width:100%}div.svelte-lightbox-footer.fullscreen.svelte-16koabs{bottom:0;left:0;padding-left:1rem;position:fixed;right:0;z-index:5}",
  map: null
};
const LightboxFooter = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div${spread([{ class: "svelte-lightbox-footer" }, escape_object($$restProps)], {
    classes: (imagePreset === "fullscreen" ? "fullscreen" : "") + " svelte-16koabs"
...
const css$2 = {
  code: 'div.svelte-lightbox-overlay.svelte-1qhkz3m{align-items:center;background-color:rgba(43,39,45,.87);bottom:0;display:flex;height:100%;justify-content:center;left:0;overflow:hidden;position:fixed;right:0;top:0;width:100%;z-index:1000000!important}div.svelte-lightbox-overlay.svelte-1qhkz3m:before{bottom:0;content:"";left:0;opacity:0;position:absolute;right:0;top:0;z-index:-1}div.svelte-lightbox-overlay.svelte-1qhkz3m:after{clear:both;content:"";display:table}',
  map: null
};
const ModalCover = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div${spread([{ class: "svelte-lightbox-overlay" }, escape_object($$restProps)], { classes: "svelte-1qhkz3m" })}>${slots.default ? slots.default({}) : ``}
</div>`;
});
const css$1 = {
  code: "div.svelte-lightbox-main.svelte-2twfyz{background-color:transparent;height:auto;max-height:100%;max-width:100%;position:relative;width:auto}div.svelte-lightbox-main.fullscreen.svelte-2twfyz{height:inherit;max-height:inherit;max-width:inherit;width:inherit}",
  map: null
};
const Modal = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div${spread([{ class: "svelte-lightbox-main" }, escape_object($$restProps)], {
    classes: (imagePreset === "fullscreen" ? "fullscreen" : "") + " " + (imagePreset === "scroll" ? "scroll" : "") + " svelte-2twfyz"
  })}>${slots.default ? slots.default({}) : ``}
</div>`;
});
